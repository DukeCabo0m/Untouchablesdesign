    ...
    <div className="relative pt-32 pb-24 px-4 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <motion.nav
          ...
          className="mb-8"
        >
          <ol className="flex items-center gap-3 font-mono text-xs text-[#E0E0E0]/70 uppercase">
        ...
        <div>
          ...
          <div className="flex items-center gap-4 mb-6 overflow-hidden">
            ...
            <motion.span
              ...
              className={`font-black text-[#8B0000] leading-none flex-shrink-0 ${
                title.length > 18 ? 'text-6xl md:text-8xl' : 'text-6xl md:text-8xl'
              }`}
            ...
            <h1
              className={`font-black text-[#E0E0E0] uppercase tracking-[-0.05em] leading-none whitespace-nowrap overflow-hidden flex-1 min-w-0 ${
                title.length > 18 ? 'text-6xl md:text-7xl' : 'text-6xl md:text-8xl'
              }`}
              style={{ fontFamily: 'Arial Black, sans-serif' }}
            >
              {showTitle && (
                <>
                  ...
                  {!animationComplete && (
                    <motion.span
                      ...
                      className={`inline-block w-1 bg-[#8B0000] ml-2 align-middle ${
                        title.length > 18 ? 'h-16 md:h-24' : 'h-16 md:h-24'
                      }`}
                    />
                  )}
                </>
          ...
          {animationComplete && (
            <motion.div
              ...
              transition={{ duration: 0.8, delay: 0.3 }} // Durée augmentée et délai ajouté
          ...
          {animationComplete && (
            <motion.p
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.9 }} // Délai augmenté pour après la ligne rouge
              className="font-mono text-sm text-[#E0E0E0]/70 max-w-2xl"
