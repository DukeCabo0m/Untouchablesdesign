    ...
    <div className="min-h-screen py-32 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          >
            <GlitchText glitchIntensity="high">POLITIQUE DE COOKIES</GlitchText>
          </h1>

          <p className="text-xl text-[#a8a8a8] leading-loose border-l-4 border-[#8B0000] pl-6">
            Comment nous utilisons les cookies et autres technologies de suivi pour améliorer votre expérience sur Untouchables.
          </p>
        </motion.div>
