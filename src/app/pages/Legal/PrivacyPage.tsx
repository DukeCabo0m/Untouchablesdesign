  ...
  return (
    <div className="min-h-screen">
      ...
      <PageHeader
        ...
        description="Votre vie privée est importante. Cette politique explique comment nous collectons, utilisons et protégeons vos données.<br />Transparence totale sur le traitement de vos informations personnelles."
