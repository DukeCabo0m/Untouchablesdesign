  ...
  return (
    <div className="min-h-screen">
      ...
      <PageHeader
        ...
        description="En utilisant le site Untouchables, vous acceptez les présentes conditions d'utilisation.<br />Lisez attentivement les règles de la communauté et vos droits et obligations."
